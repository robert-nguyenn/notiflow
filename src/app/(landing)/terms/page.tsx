          ...
          <div className="grid gap-12">
            ...
            <section className="bg-slate-800/30 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl font-bold text-white">User Accounts & Responsibilities</h2>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li>• <strong className="text-white">Pro Plan:</strong> $49/month, billed annually</li>
                      <li>• <strong className="text-white">Enterprise:</strong> Custom pricing available</li>
                    </ul>
                  </div>
                  
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-4">Billing Terms</h3>
                    <ul className="space-y-2">
            ...
            <section className="bg-slate-800/30 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              ...
              <div className="text-gray-300 space-y-4 text-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-2">Our Rights</h4>
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-2">Effect of Termination</h4>
              ...
              <div className="text-gray-300 space-y-4 text-lg">
                ...
                <div className="bg-slate-900/50 p-6 rounded-xl border border-white/5">
                  <div className="space-y-3">
                    ...
                    <div>
                      <strong className="text-white">Business Hours:</strong> Monday-Friday, 9:00 AM - 5:00 PM PST
                    </div>
                  </div>
                </div>
              </div>
