          ...
          <div className="py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-3">
                <a href="mailto:hello@notifyflow.com" className="w-10 h-10 bg-gray-100 hover:bg-purple-100 rounded-lg flex items-center justify-center transition-colors duration-200 group" title="Email Us">
                  <span className="text-gray-600 group-hover:text-purple-600 text-lg">📧</span>
                </a>
                <a href="/contact" className="w-10 h-10 bg-gray-100 hover:bg-blue-100 rounded-lg flex items-center justify-center transition-colors duration-200 group" title="Contact Support">
                  <span className="text-gray-600 group-hover:text-blue-600 text-lg">💬</span>
                </a>
                <a href="https://github.com/robert-nguyenn/notificationpanda" className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-200 group" title="GitHub Repository">
                  <span className="text-gray-600 group-hover:text-gray-900 text-lg">🔗</span>
                </a>
              </div>
            </div>
