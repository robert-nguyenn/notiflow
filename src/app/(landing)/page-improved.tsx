          ...
          <div className="py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-3">
                <a href="mailto:your-email@gmail.com" className="w-10 h-10 bg-gray-100 hover:bg-red-100 rounded-lg flex items-center justify-center transition-colors duration-200 group" title="Gmail">
                ...
                <a href="https://linkedin.com/in/your-profile" className="w-10 h-10 bg-gray-100 hover:bg-blue-100 rounded-lg flex items-center justify-center transition-colors duration-200 group" title="LinkedIn">
                ...
                <a href="https://github.com/your-username" className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-200 group" title="GitHub">
