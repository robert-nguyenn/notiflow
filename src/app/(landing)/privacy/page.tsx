...
const PrivacyPage = () => {
  return (
    <div className="relative bg-gradient-to-br from-slate-50 via-white to-purple-50 min-h-screen">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-purple-200 to-blue-200 rounded-full blur-3xl opacity-20"></div>
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-blue-200 to-cyan-200 rounded-full blur-3xl opacity-20"></div>
              ...
              <div className="text-gray-600 space-y-6 text-lg">
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <strong className="text-gray-900">Service Providers:</strong> We work with trusted third-party providers for payment processing, email delivery, and analytics. These providers are contractually required to protect your information.
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    <div className="w-2 h-2 bg-purple-400 rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <strong className="text-gray-900">Legal Requirements:</strong> We may disclose information if required by law, court order, or to protect our rights and safety.
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    <div className="w-2 h-2 bg-purple-400 rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <strong className="text-gray-900">Business Transfers:</strong> In the event of a merger, acquisition, or sale, your information may be transferred as part of the business assets.
                    </div>
                  </div>
                </div>
              </div>
